...
namespace KutuphaneOtomasyonu.Forms
{
    public partial class KiralamaPaneli : Form
    {
        ...
        private void Listele()
        {
            ...
            foreach (DataGridView dataGridView in new[] { KitaplarDataGridView, KitaplarDataGridView2 })
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (onay == DialogResult.Yes)
                        {
                            ...
                            DateTime sinavTarihi = new DateTime(2022, 6, 25);
                            TimeSpan ts = sinavTarihi - bugun;
                            ...
                            MessageBox.Show(secilenKisi.Uye_Adi + " adlı üyeye \n" +
                                                            secilenKitap.Kitap_Adi + " adlı kitabı " + " günlüğüne kiraladınız"
